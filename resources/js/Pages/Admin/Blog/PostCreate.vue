<template>
  <AdminLayout>
    <template #pageTitle>Nova Postagem</template>
        ...
        <div class="space-y-6">
          ...
          <div>
            ...
            <div v-if="featuredPreviewUrl" class="mt-4">
              <img :src="featuredPreviewUrl" alt="Imagem de destaque" class="w-full h-40 object-cover rounded-xl border border-gray-200">
