<template>
  <footer class="site-footer-bg text-white mt-12">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-300">
            ...
            <li><a href="/imoveis" class="hover:text-white transition">Imóveis</a></li>
            <li><a href="/venda-seu-imovel" class="hover:text-white transition">Venda seu Imóvel</a></li>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-300">
            <li v-if="telefone">{{ telefone }}</li>
            <li v-if="email">{{ email }}</li>
            <li v-if="endereco">{{ endereco }}</li>
          </ul>
        </div>
        <div>
          <h4 class="font-semibold mb-4">Redes sociais</h4>
          <div class="flex space-x-4">
            <a v-if="facebookUrl" :href="facebookUrl" target="_blank" rel="noopener" class="text-gray-300 hover:text-white transition">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a v-if="instagramUrl" :href="instagramUrl" target="_blank" rel="noopener" class="text-gray-300 hover:text-white transition">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
